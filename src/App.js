...
function App() {
	return (
		...
		>
			<body className='flex flex-col my-6 content-center max-w-xs h-auto rounded-b-lg shadow-2xl'>
				<img
				...
				<div className='flex w-full justify-between items-center p-3 bg-slate-50'>
					<img
						...
						alt=''
					/>
					<button className='bg-transparent flex justify-center items-center h-6 w-24 hover:bg-slate-500 text-slate-700 hover:text-white py-2 px-4 border border-slate-300 hover:border-transparent rounded'>
						<a
